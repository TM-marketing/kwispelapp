...
const navigationItems = [
  ...
  { title: "Alle Honden", url: createPageUrl("AlleHonden"), icon: PawPrint },
...
export default function AppLayout({ children }) {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full" style={{ background: 'linear-gradient(135deg, #f5f7fa 0%, #fce4ec 100%)' }}>
                  ...
                  {navigationItems.map((item) => (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                        ...
                        style={{ backgroundColor: location.pathname === item.url ? 'var(--primary-blue)' : 'transparent' }}
                      >
