...
export default function Dashboard() {
  ...
  const statusColors = {
    overgewicht: "bg-orange-100 text-orange-700 border-orange-200",
    ondergewicht: "bg-yellow-100 text-yellow-700 border-yellow-200",
    allergieën: "bg-red-100 text-red-700 border-red-200",
    huidproblemen: "bg-purple-100 text-purple-700 border-purple-200",
    spijsverteringsproblemen: "bg-blue-100 text-blue-700 border-blue-200",
    gedragsproblemen: "bg-pink-100 text-pink-700 border-pink-200",
  };
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="kwiek-heading text-3xl md:text-4xl">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-2 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300"
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg" style={{ color: 'var(--primary-blue)' }}>
                Totaal Honden
              </CardTitle>
        ...
        <Link to={createPageUrl("Agenda")}>
          <Card className="border-2 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer"
                style={{ borderColor: 'var(--primary-pink)' }}>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg" style={{ color: 'var(--primary-blue)' }}>
                ...
                <div className="w-12 h-12 rounded-full flex items-center justify-center"
                     style={{ backgroundColor: 'var(--primary-pink)' }}>
                  <Calendar className="w-6 h-6" style={{ color: 'var(--primary-blue)' }} />
                </div>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card className="border-2 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300"
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 rounded-full flex items-center justify-center"
                   style={{ backgroundColor: 'var(--primary-pink)' }}>
                <TrendingUp className="w-6 h-6" style={{ color: 'var(--primary-blue)' }} />
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-4xl font-bold" style={{ color: 'var(--primary-blue)' }}>
              {dogsLoading ? '-' : dogs.filter(d => d.status_tags && d.status_tags.length > 0).length}
            </p>
          </CardContent>
        </Card>
      </div>
